...
import { UnifiedResourceGuard } from './unified-resource.guard';

describe('UnifiedResourceGuard', () => {
  let guard: UnifiedResourceGuard;

  beforeEach(() => {
    // @ts-expect-error - testing constructor
    guard = new UnifiedResourceGuard();
    jest
      .spyOn(
        Object.getPrototypeOf(UnifiedResourceGuard.prototype),
        'canActivate',
      )
